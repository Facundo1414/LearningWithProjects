    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="nav--logo--section">
          <img className="nav--logo--section--img" src="./img/logo Romano.png" alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/facuallende.14/"
            ...
            <li>
              <a
                href="https://twitter.com/AFacu14"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/facundoallende14"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by A&F</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
